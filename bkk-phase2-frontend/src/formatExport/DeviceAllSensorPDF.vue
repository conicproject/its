            ...
            <v-card class="elevation-0 pl-16 pt-5 pr-10">
              ...
              <v-card-text  class="pt-5">
                ...
                <table id="mytable" >   
                    ...
                    <tr v-for="item in dataOn" :key="item">
                      <td>{{item.name}}</td>  
                      <td>{{item.ip}}</td>
                      <td>{{item.checkpoint}}</td>              
                    </tr>  
                ...
                <table id="mytableX" data-cols-width="20,20,20">  
                    ...
                    <tr data-height="25">
                      <th data-f-sz="15" colspan="3">ไม่ทำงาน(down)</th>
                    </tr>           
                    <tr >
                    ...
                    <tr  data-height="25" v-for="item in dataOff" :key="item">
                    ...
                    <tr data-height="25">
                      <th data-f-sz="15" colspan="3">ทำงาน(Up)</th>
                    </tr>           
                    <tr>
                       <th data-f-sz="15">อุปกรณ์</th>
                      <th data-f-sz="15">IP Address</th>
                    ...
                    <tr  data-height="25" v-for="item in dataOn" :key="item">
                     <td data-f-sz="15">{{item.name}}</td>  
                      <td data-f-sz="15">{{item.ip}}</td>
                      <td data-f-sz="15">{{item.checkpoint}}</td>            
                    </tr>
...
export default {
  props: ["downloadpdf","downloadexcel","dataOn","dataOff"],
  components: {
    VueHtml2pdf,
  },
  watch: { 
  ...
  sheet: {
    name: "Sheet 1"
        ...
        genPDF(){
      let doc = new jsPDF({ orientation: "p", unit: "pt",compress:true });

      doc.addFileToVFS("THSarabunNew.ttf",fontTH.th);
      doc.addFont("THSarabunNew.ttf", "THSarabunNew", "Bold");
      doc.setFont("THSarabunNew", "Bold");
      doc.setFontSize(20);
      // doc.text("กองระบบเทคโนโลยีจราจร", 170, 30);
      // doc.text("สำนักการจราจรและขนส่ง", 170, 50);
      // doc.text("กรุงเทพมหานคร", 170, 70);
      doc.text("Report Volume & Cassification", 200, 53);
      doc.text("จุดติดตั้ง : อ่อนนุช ซอย 3", 200, 79);
      doc.text("ถนน อ่อนนุช ", 400, 53);
      doc.text("วันที่ : 2022-02-22", 400, 79);
      // doc.text("วันที่ : 2022-02-22", 350, 99);
       doc.text("All Sensors", 40, 145);
