              ...
              <v-card class="elevation-0">
                ...
                <v-card-text class="pt-5">
                  ...
                  <table id="mytable">
                    ...
                    <tbody>
                      <tr v-for="item in dataReports" :key="item.index">
                        <td>{{ item.index }}</td>
                        <td v-if="item.img_base64 !== ''">
                          <!-- <img :src="item.img_base64" /></td> -->
                  ...
                  <table id="mytableX" data-cols-width="10,30,20,30,20,20,20,20,20">
                    ...
                    <tr>
                      <th colspan="9" data-f-sz="20" data-a-h="left" data-f-bold="true">
                        รายงานข้อมูลยานพาหนะที่ฝ่าฝืนสัญญาณไฟจราจรทางคนเดินข้ามชนิดปุ่มกด</th>
                    </tr>
...
export default {
  ...
  watch: {
    downloadpdf: function (newVal, oldVal) { // watch it
      ...
      this.generateReport()
      this.genPDF()
      console.log("mytable", this.dataTableRe);
      setTimeout(() => {
        this.width = '100%'
        this.height = '100%'
      }, 2000)
  ...
  methods: {
    ...
    genPDF() {
      ...
      doc.text("รายงานข้อมูลยานพาหนะที่ฝ่าฝืนสัญญาณไฟจราจรทางคนเดินข้ามชนิดปุ่มกด", 150, 130);
      ...
      doc.save(`รายงานข้อมูลยานพาหนะที่ฝ่าฝืนสัญญาณไฟจราจรทางคนเดินข้ามชนิดปุ่มกด.pdf`);
    },
    hasDownloaded(e) {
      console.log(e);
    },
