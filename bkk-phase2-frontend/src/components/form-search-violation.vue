            ...
            <v-col>
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field hint="ช่วงเวลาที่ค้นหาข้อมูลสูงสุด 5 วัน" persistent-hint placeholder="วัน เดือน ปี พ.ศ."  outlined class="input-adddata rounded-lg sl mb-2" v-model="dayformat" readonly v-bind="attrs" v-on="on"></v-text-field>
                </template>
