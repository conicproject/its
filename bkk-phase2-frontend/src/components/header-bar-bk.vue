<template>
  ...
  <div class="d-flex justify-space-between">
    ...
    <div>
      <v-btn text><checkDevice></checkDevice></v-btn>
     <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
              <v-btn v-bind="attrs" v-on="on" text>
                
                <v-badge color="red" dot v-if="showNotification">
                  <v-icon  @click="gotoBlacklist()">notifications_active</v-icon>
                </v-badge>
                <v-icon @click="gotoBlacklist()" v-else>notifications_active</v-icon>
